...
const LATEX_COMMAND =
  /\\(?:frac|dfrac|tfrac|sqrt|sum|prod|int|lim|log|ln|exp|sin|cos|tan|alpha|beta|gamma|delta|theta|lambda|mu|pi|sigma|phi|omega|infty|cdot|times|pm|leq|geq|neq|approx|rightarrow|left|right)\b/;
...
export type MathSegment = { type: "text"; text: string } | { type: "math"; latex: string };
